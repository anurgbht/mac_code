...
def make_code():
    separate_booster()
    write_path = "D:/OneDrive - Tata Insights and Quants, A division of Tata Industries/Employee Personal/practice/Understanding Models/XgBoost_Classification/codes/"
    os.chdir("D:/OneDrive - Tata Insights and Quants, A division of Tata Industries/Employee Personal/practice/Understanding Models/XgBoost_Classification/data/")
...
def separate_booster():
    write_path = "D:/OneDrive - Tata Insights and Quants, A division of Tata Industries/Employee Personal/practice/Understanding Models/XgBoost_Classification/data/"
...
def my_predict(X):
    ...
    for i in X:
        temp_pred = 0
        for count, est in enumerate(at.all_pred_func):
            temp_pred += est(i)
        tt.append(temp_pred)
...
plt.plot(my_predict(X),[x[-1] for x in clf.predict_proba(X)],'.')
