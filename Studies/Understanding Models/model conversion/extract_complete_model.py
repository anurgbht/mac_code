...
def make_if_else(model,vessel):
    ...
    fw = open(write_path+vessel+"_"+model+"_all_trees.py","a+")
    all_pred_func = "\n\nall_pred_func = ["
...
def write_gen(vessel,model,save_path,write_path):
    ...
    fw = open(write_path+vessel+"_"+model+"_all_trees.py","w")
...
for  vessel in vessels:
    for model in models:
        write_gen(vessel,model,save_path,write_path)
