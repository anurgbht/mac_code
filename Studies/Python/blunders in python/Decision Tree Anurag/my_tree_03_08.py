...
class Tree():
    ...
    def build_tree(self):
        ## Node class is recursive
        ## initiating the class with data will recursively build the tree
        ## untill stop condition is encountered
...
mod_excel = pd.read_excel(os.getcwd()+'/data/DT_data.xlsx',sheet_name = 0)
