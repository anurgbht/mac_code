...
##mod_excel = pd.read_csv("FeatureDat_DT_V3.csv")
mod_excel = pd.read_excel('DT_data.xlsx',sheet_name = 'dummy_data')
...
tree.plot_tree('original')
tree.edit_node(2,'weight',80)
tree.plot_tree('edited')
