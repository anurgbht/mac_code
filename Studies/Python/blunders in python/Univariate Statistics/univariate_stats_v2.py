...
os.chdir("D:/OneDrive - Tata Insights and Quants, A division of Tata Industries/Confidential/Projects/Steel/OLP Al/data/")

sys.stdout=open("external.log","w")

file_list=['OLP_raw_dat.xlsx']
##file_list = os.listdir()

writer = pd.ExcelWriter('summary_olp.xlsx')
