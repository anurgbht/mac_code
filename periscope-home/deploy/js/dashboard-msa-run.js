(function ($) {
    ...
    if ($('#cash-deposits-chart').length) {
      ...
      var data = {
        ...
        datasets: [
          ...
          {
            label: 'Scenario 2',
            data: [12, 15, 13, 14, 8, 11, 15, 12, 17],
            borderColor: [
              '#4d83ff'
            ],
            borderWidth: 2,
  ...
  if ($("#doughnut-chart").length) {
    ...
    document.getElementById('doughnut-chart-legend').innerHTML = totalSalesChart.generateLegend();
  }
})(jQuery);